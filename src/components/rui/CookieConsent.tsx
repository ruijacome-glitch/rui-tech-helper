          ...
          <div className="mx-auto flex max-w-7xl flex-col gap-5 px-4 py-5 sm:px-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                className="min-h-11 flex-1 rounded-sm border border-electric bg-electric px-4 text-sm font-semibold text-foreground transition-colors hover:bg-electric/85 sm:flex-none"
              >
                Aceitar todos
              </button>
            </div>
          ...
          >
            ...
            <div className="mt-7 flex flex-wrap gap-2">
              ...
              <button
                type="button"
                onClick={() => decidir({ necessarios: true, analise: true, marketing: true })}
                className="min-h-11 flex-1 rounded-sm border border-electric bg-electric px-4 text-sm font-semibold text-foreground transition-colors hover:bg-electric/85"
              >
                Aceitar todos
              </button>
            </div>
